...
export type SkillLinkingCollectionsSkillsSectionCollectionArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
  locale: InputMaybe<Scalars['String']['input']>;
  order: InputMaybe<Array<InputMaybe<SkillLinkingCollectionsSkillsSectionCollectionOrder>>>;
  preview: InputMaybe<Scalars['Boolean']['input']>;
  skip?: InputMaybe<Scalars['Int']['input']>;
};
...
export enum SkillLinkingCollectionsSkillsSectionCollectionOrder {
  InternalNameAsc = 'internalName_ASC',
  InternalNameDesc = 'internalName_DESC',
  SysFirstPublishedAtAsc = 'sys_firstPublishedAt_ASC',
  SysFirstPublishedAtDesc = 'sys_firstPublishedAt_DESC',
...
export type SkillsSection = Entry & {
  __typename?: 'SkillsSection';
  contentfulMetadata: ContentfulMetadata;
  description: Maybe<Scalars['String']['output']>;
  internalName: Maybe<Scalars['String']['output']>;
  linkedFrom: Maybe<SkillsSectionLinkingCollections>;
  skillsCollection: Maybe<SkillsSectionSkillsCollection>;
  sys: Sys;
  title: Maybe<Scalars['String']['output']>;
};
...
/** [See type definition](https://app.contentful.com/spaces/v8rltx4kw8l0/content_types/skillsSection) */
export type SkillsSectionSkillsCollectionArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
  locale: InputMaybe<Scalars['String']['input']>;
  order: InputMaybe<Array<InputMaybe<SkillsSectionSkillsCollectionOrder>>>;
  preview: InputMaybe<Scalars['Boolean']['input']>;
  skip?: InputMaybe<Scalars['Int']['input']>;
  where: InputMaybe<SkillFilter>;
};
...
export type SkillsSectionSkillsCollection = {
  __typename?: 'SkillsSectionSkillsCollection';
  items: Array<Maybe<Skill>>;
  limit: Scalars['Int']['output'];
  skip: Scalars['Int']['output'];
  total: Scalars['Int']['output'];
...
export enum SkillsSectionSkillsCollectionOrder {
  InternalNameAsc = 'internalName_ASC',
  InternalNameDesc = 'internalName_DESC',
  NameAsc = 'name_ASC',
  NameDesc = 'name_DESC',
...
export type SkillsSectionFragment = { __typename: 'SkillsSection', title: string | null, description: string | null, skillsCollection: { __typename?: 'SkillsSectionSkillsCollection', items: Array<{ __typename?: 'Skill', sys: { __typename?: 'Sys', id: string } } | null> } | null };
